...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-11-2023 a las 03:20:13
...
CREATE TABLE `especialidad` (
  ...
  `tipoEspecialidad` enum('WINDOWS','LINUX','MacOS','SAP','TANGO','ANDROID') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `habilidad`
  ...
  ADD CONSTRAINT `habilidad_ibfk_2` FOREIGN KEY (`idEspecialidad`) REFERENCES `especialidad` (`idEspecialidad`);
...
ALTER TABLE `serviciocontratado`
  ...
  ADD CONSTRAINT `serviciocontratado_ibfk_2` FOREIGN KEY (`idEspecialidad`) REFERENCES `especialidad` (`idEspecialidad`);

--
-- Filtros para la tabla `tipoproblema`
--
ALTER TABLE `tipoproblema`
  ADD CONSTRAINT `tipoproblema_ibfk_1` FOREIGN KEY (`idEspecialidad`) REFERENCES `especialidad` (`idEspecialidad`);
COMMIT;
